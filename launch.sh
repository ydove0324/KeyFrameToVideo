...
# 分布式训练节点配置
WORKER_NODES=("job-9482f467-5d0f-41c3-aba6-8c76b1cba5da-master-0")
NUM_NODES=2  # Master + Worker
MASTER_GPUS=4
WORKER_GPUS=4
MASTER_ADDR="job-548b4817-10df-4275-bbf0-c21e8239532d-master-0"
MASTER_PORT="23456"
JOB_ID="100"

# 训练脚本路径
TRAIN_SCRIPT="examples/training/sft/wan/pixabay_img/train.sh"
