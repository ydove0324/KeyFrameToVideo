...
TRAINING_DATASET_CONFIG="examples/training/sft/wan/video-pretrain-first-frame-condition/training.json"
VALIDATION_DATASET_FILE="examples/training/sft/wan/video-pretrain-first-frame-condition/validation.json"
...
miscellaneous_cmd=(
  ...
  --output_dir "/share/project/huangxu/model/wan-ibq-key-frame-video-pretrain-first-frame-condition"
  --init_timeout 600
  --nccl_timeout 600
  --report_to "wandb"
)
