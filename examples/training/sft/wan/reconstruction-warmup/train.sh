...
TRAINING_DATASET_CONFIG="examples/training/sft/wan/reconstruction-warmup/training.json"
VALIDATION_DATASET_FILE="examples/training/sft/wan/reconstruction-warmup/validation.json"
...
miscellaneous_cmd=(
  --tracker_name "finetrainers-wan-ibq-key-frame-reconstruction-warmup"
  --output_dir "/share/project/huangxu/model/wan-ibq-key-frame-reconstruction-warmup"
  --init_timeout 600
  --nccl_timeout 600
  --report_to "wandb"
)
