...
TRAINING_DATASET_CONFIG="examples/training/sft/wan/video-pretrain/training.json"
VALIDATION_DATASET_FILE="examples/training/sft/wan/video-pretrain/validation.json"
...
miscellaneous_cmd=(
  ...
  --output_dir "/share/project/huangxu/model/wan-ibq-key-frame-video-pretrain"
  --init_timeout 600
  --nccl_timeout 600
  --report_to "wandb"
)
